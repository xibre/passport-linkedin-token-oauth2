...
LinkedinTokenStrategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(profileUrl, accessToken, function (err, body, res) {
    if (err) {
      console.log('LinkedinTokenStrategy: failed to fetch user profile', profileUrl, accessToken, err);
    ...
    try {
      ...
      console.log('LinkedinTokenStrategy: failed to parse profile', profileUrl, accessToken, body, e);
      done(e);
    }
  });
}
